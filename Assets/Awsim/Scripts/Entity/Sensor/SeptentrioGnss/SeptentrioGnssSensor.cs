...
namespace Awsim.Entity
{
    ...
    /// </summary>
    public class SeptentrioGnssSensor : MonoBehaviour
    {
        ...
        [SerializeField] int _outputHz = 50;      // Autoware gnss sensor basically output at 1hz.
        // [SerializeField] GnssOutputMode _outputMode = GnssOutputMode.NavSatFix;
