...
namespace Awsim.Scene.AutowareSimulationSeptentrio
{
    public class AutowareSimulationSeptentrio : MonoBehaviour
    {
        [Serializable]
        ...
        [Header("Ego Vehicle")]
        [SerializeField] EgoVehicleWithSeptentrio _egoVehicle;
